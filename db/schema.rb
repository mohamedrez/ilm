...
ActiveRecord::Schema[7.1].define(version: 2023_12_22_174117) do
  ...
  create_table "lectures", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "matne_id", null: false
    t.index ["matne_id"], name: "index_lectures_on_matne_id"
    t.index ["scholar_id"], name: "index_lectures_on_scholar_id"
  end

  create_table "matnes", force: :cascade do |t|
    t.string "title"
    t.integer "scholar_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["scholar_id"], name: "index_matnes_on_scholar_id"
  end
  ...
  add_foreign_key "lectures", "matnes"
  add_foreign_key "lectures", "scholars"
  add_foreign_key "matnes", "scholars"
